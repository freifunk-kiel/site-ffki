...
TINY="ar71xx-tiny" # Support for for 841 since lede, needs less packages, so the 4MB will suffice!
...
TARGETS="ar71xx-generic $TINY ar71xx-nand $WDR4900 $RASPBPI $X86 x86-geode ipq806x ramips-mt76x8"
if [ "$BROKEN" != "" ]; then
